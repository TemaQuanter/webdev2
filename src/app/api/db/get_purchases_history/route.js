/*
    This file contains a logic for retrieving entire purchases history.
*/
...
export const GET = async (req) => {
  ...
  try {
    ...
    purchasesHistory = await prisma.purchases.findMany({
      where: {
  ...
  // Return the purchases history.
  return NextResponse.json(purchasesHistory, { status: 200 })
} // end function GET
